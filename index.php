...
if(!empty($_POST["login"]) && !empty($_POST["email"]) && !empty($_POST["password"]) && !empty($_POST["loginType"]) && $_POST["loginType"]) {	
	...
	$loginMessage = 'Please enter your email and password, and choose what type you want to enter!';
}
include('inc/header.php');
?>
<title>FICS Online Exam System</title>
<?php include('inc/container.php');?>
<div class="content"> 
	<div class="container-fluid">
		<h2>Welcome to FICS Online Exam System</h2>			
        <div class="col-md-6">                    
		<div class="panel panel-info">
			...
			<div style="padding-top:30px" class="panel-body" >
				...
				<form id="loginform" class="form-horizontal" role="form" method="POST" action="">                                    
					...
					<label class="radio-inline">
					  <input type="radio" name="loginType" value="user">Student
					</label>
